...
import static com.fajar.wsclient.components.ReservedFor.AFTER_HOR;
import static com.fajar.wsclient.components.ReservedFor.AFTER_VER;
import static com.fajar.wsclient.components.ReservedFor.BEFORE_HOR;
import static com.fajar.wsclient.components.ReservedFor.BEFORE_VER;
import com.fajar.wsclient.util.StringUtil;
import com.fajar.wsclient.util.ThreadUtil;
import com.fajar.wsclient.util.Log;
...
//		comboBox.addActionListener(actionListener);
	 ...
	 * @return
	 */
	public static JLabel infoLabel(Object title, int horizontalAligment) {
		if(null == title) {
			title = "";
		}
